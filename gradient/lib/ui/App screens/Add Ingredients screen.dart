...
import 'package:gradient/ui/App%20screens/Add%20Nutrition.dart';
...
class AddIngredientsScreen extends StatelessWidget {
  ...
  Widget _buildPhotoUploadCard() {
    return Container(
      ...
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), //paddin
  ...
  //button
  Widget _buildActionButtonsRow(context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: defaultPadding),
      child: Row(
        children: [
